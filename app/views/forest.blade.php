...
@section('content')
<body class="forestbody">
	<div class="forest container-fluid">
		<div class="tree-level row-fluid">
			<div class="sun-top"><div class="sun-bottom"></div><div class="mountain"></div></div>
		<div class="row-fluid">
			<div class="text-center information forestinfo">
				...
				<br> --}}
				<span class="healthbar">Health: 100%</span>
				<div class="progress">
					<div class="health progress-bar progress-bar-danger" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%"></div>
				</div>
			...
			<div class="tree"><div class="squirrelhole"></div></div>
			<div class="tree"><div class="squirrelhole"></div></div>
			<div class="tree"><div class="squirrelhole"></div></div>
			<div class="tree"><div class="squirrelhole"></div></div>
			<div class="tree"><div class="squirrelhole"></div></div>
...
<form id="exitforestform" method="POST" action="{{{action('HomeController@exitforest')}}}">
	<input type="hidden">
</form>
@stop
...
// });
 ...
 $(document).keydown(function(event){
    ...
    var wizardlocation = $(".wizard").offset();
    if(scroll >= 11100) {
    	$("#exitforestform").submit();
    }
...
// The "D" key. Moving to the right
    if(input == 68) {
    	...
    	scroll = scroll + 100;
 		...
 		console.log("X-axis: " + wizardlocation.left)
